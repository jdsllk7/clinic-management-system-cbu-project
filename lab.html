...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <a class="btn_2 d-none d-lg-block" href="doctor.html">Send to Doctor </a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <section class="regervation_part section_padding">
        <div class="container">
            <h1 class="text-white text-center">Lab's View</h1>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <textarea class="form-control" id="Textarea" rows="4"
                                        placeholder="Enter Lab Results..."></textarea>
                                </div>
                            </div>
                            <div class="regerv_btn">
                                <a href="doctor.html" class="btn_2 d-none d-lg-block">Send Back to Doctor</a>
                            </div>
                            <br>
                            <br>
                            <br>
