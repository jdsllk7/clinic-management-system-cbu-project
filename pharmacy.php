                ...
                <div class="regervation_part_iner">
                    ...
                    <form method="post" id="nextOfficeForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" autocomplete="on">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <textarea class="form-control disabled" disabled id="Textarea" rows="4" placeholder="Enter Prescription..."><?php
                                                                                                                                            if (isset($_COOKIE["rPrescription"])) {
                                                                                                                                                echo $_COOKIE["rPrescription"];
                                                                                                                                            } ?>
                                </textarea>
                            </div>
                        </div>
                        <input type="hidden" name="nextOffice" value="toFinish">
                        <input type="hidden" name="rId" value="<?php if (isset($_COOKIE["rId"])) {
                                                                    echo $_COOKIE["rId"];
                                                                } ?>">
                        <div class="regerv_btn">
                            <a href="#!" class="btn_2 d-none d-lg-block" id="sendToNextOffice">Finish</a>
                        </div>
                        <br>
                        <br>
                        <br>
